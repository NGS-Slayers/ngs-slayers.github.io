...
<script>
document.addEventListener('DOMContentLoaded', function() {
  genTable("ChargedBlade",ChargedBlade,'Charged Blade', calcProp(ChargedBlade,cNA),'cNA>Charged Blade', calcProp(ChargedBlade,scNA),'scNA>Charged Blade');
});
</script>
```
...
<script>
document.addEventListener('DOMContentLoaded', function() {
  genTable("BCNA",BCNA,'BCNA', calcProp(WA1,BCNA),'WA1>BCNA', calcProp(WA2,BCNA),'WA2>BCNA', calcProp(WA3,BCNA),'WA3>BCNA');
});
</script>
```
...
<script>
document.addEventListener('DOMContentLoaded', function() {
  genTable("BCWA",BCWA,'BCWA', calcProp(WA1,BCWA),'WA1>BCWA', calcProp(WA2,BCWA),'WA2>BCWA', calcProp(WA3,BCWA),'WA3>BCWA');
});
</script>
```
...
<script>
document.addEventListener('DOMContentLoaded', function() {
  genTable("BCWA-WA123",calcProp(WA1,Cancel(BCWA,'WA'),WA1,WA2,WA3),'WA1>BCWA>WA123', calcProp(WA2,Cancel(BCWA,'WA'),WA1,WA2,WA3),'WA2>BCWA>WA123', calcProp(WA3,Cancel(BCWA,'WA'),WA1,WA2,WA3),'WA3>BCWA>WA123');
});
</script>
```
