...
<script>
document.addEventListener('DOMContentLoaded', function() {
  genTable("RRC3",calcProp(sRR,ChargedBladePA),'w/ sRR', calcProp(sRR,Cancel(ChargedBladePA,'WA'),WA2,WA3), 'w/ sRR + WA23', calcProp(mRR,ChargedBladePA),'w/ mRR', calcProp(mRR,Cancel(ChargedBladePA,'WA'),WA2,WA3), 'w/ mRR + WA23');
});
</script>
```
